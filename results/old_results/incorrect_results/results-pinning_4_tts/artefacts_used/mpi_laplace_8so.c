          ...
          for (int y0_blk0 = y_m - lower_y_offset; y0_blk0 <= y_M + upper_y_offset; y0_blk0 += y0_blk0_size)
          {
            for (int x = x0_blk0; x <= MIN(x0_blk0 + x0_blk0_size - 1, x_M + upper_x_offset); x += 1)
            {
              for (int y = y0_blk0; y <= MIN(y0_blk0 + y0_blk0_size - 1, y_M + upper_y_offset); y += 1)
              {
                ...
                {
		 float r4 = -1.42361111100763F*u[t0][x + 32][y + 32][z + 32];
		 u[t1][x + 32][y + 32][z + 32] = dt*(r0*(r4 + (-8.9285714284415e-4F)*(u[t0][x + 28][y + 32][z + 32] + u[t0][x + 36][y + 32][z + 32]) + 1.26984126982279e-2F*(u[t0][x + 29][y + 32][z + 32] + u[t0][x + 35][y + 32][z + 32]) + (-1.00000000005821e-1F)*(u[t0][x + 30][y + 32][z + 32] + u[t0][x + 34][y + 32][z + 32]) + 8.00000000046566e-1F*(u[t0][x + 31][y + 32][z + 32] + u[t0][x + 33][y + 32][z + 32])) + r1*(r4 + (-8.9285714284415e-4F)*(u[t0][x + 32][y + 28][z + 32] + u[t0][x + 32][y + 36][z + 32]) + 1.26984126982279e-2F*(u[t0][x + 32][y + 29][z + 32] + u[t0][x + 32][y + 35][z + 32]) + (-1.00000000005821e-1F)*(u[t0][x + 32][y + 30][z + 32] + u[t0][x + 32][y + 34][z + 32]) + 8.00000000046566e-1F*(u[t0][x + 32][y + 31][z + 32] + u[t0][x + 32][y + 33][z + 32])) + r2*(r4 + (-8.9285714284415e-4F)*(u[t0][x + 32][y + 32][z + 28] + u[t0][x + 32][y + 32][z + 36]) + 1.26984126982279e-2F*(u[t0][x + 32][y + 32][z + 29] + u[t0][x + 32][y + 32][z + 35]) + (-1.00000000005821e-1F)*(u[t0][x + 32][y + 32][z + 30] + u[t0][x + 32][y + 32][z + 34]) + 8.00000000046566e-1F*(u[t0][x + 32][y + 32][z + 31] + u[t0][x + 32][y + 32][z + 33])) + r3*u[t0][x + 32][y + 32][z + 32] + 1.0e-1F);
                }
              }
            }
          }
