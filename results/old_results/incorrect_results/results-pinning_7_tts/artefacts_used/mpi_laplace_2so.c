          ...
          for (int y0_blk0 = y_m - lower_y_offset; y0_blk0 <= y_M + upper_y_offset; y0_blk0 += y0_blk0_size)
          {
            for (int x = x0_blk0; x <= MIN(x0_blk0 + x0_blk0_size - 1, x_M + upper_x_offset); x += 1)
            {
              for (int y = y0_blk0; y <= MIN(y0_blk0 + y0_blk0_size - 1, y_M + upper_y_offset); y += 1)
              {
                ...
                {
                  u[t1][x + 14][y + 14][z + 14] = dt*(-r0*u[t0][x + 14][y + 14][z + 14] - r1*u[t0][x + 14][y + 14][z + 14] - r2*u[t0][x + 14][y + 14][z + 14] + r3*u[t0][x + 14][y + 14][z + 14] + 5.0e-1F*(r0*u[t0][x + 13][y + 14][z + 14] + r0*u[t0][x + 15][y + 14][z + 14] + r1*u[t0][x + 14][y + 13][z + 14] + r1*u[t0][x + 14][y + 15][z + 14] + r2*u[t0][x + 14][y + 14][z + 13] + r2*u[t0][x + 14][y + 14][z + 15]) + 1.0e-1F);
