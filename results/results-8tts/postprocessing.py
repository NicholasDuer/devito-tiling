...
def generate_bar_graph(space_order):
    ...
    for standard_row in standard_csv:
        ...
        results.append([experiment_name, get_avg_time(overlapped_times), get_avg_time(standard_times)])
    ...
    def save_graph(results):
        ...
        df = pd.DataFrame(results, columns=['Dimensions', 'Overlapped Tiling MPI', 'Standard MPI'])
