          ...
          for (int y0_blk0 = y_m - lower_y_offset; y0_blk0 <= y_M + upper_y_offset; y0_blk0 += y0_blk0_size)
          {
            for (int x = x0_blk0; x <= MIN(x0_blk0 + x0_blk0_size - 1, x_M + upper_x_offset); x += 1)
            {
              for (int y = y0_blk0; y <= MIN(y0_blk0 + y0_blk0_size - 1, y_M + upper_y_offset); y += 1)
              {
                ...
                {
                  float r4 = -1.42361111100763F*u[t0][x + 56][y + 56][z + 56];
                  u[t1][x + 56][y + 56][z + 56] = dt*(r0*(r4 + (-8.9285714284415e-4F)*(u[t0][x + 52][y + 56][z + 56] + u[t0][x + 60][y + 56][z + 56]) + 1.26984126982279e-2F*(u[t0][x + 53][y + 56][z + 56] + u[t0][x + 59][y + 56][z + 56]) + (-1.00000000005821e-1F)*(u[t0][x + 54][y + 56][z + 56] + u[t0][x + 58][y + 56][z + 56]) + 8.00000000046566e-1F*(u[t0][x + 55][y + 56][z + 56] + u[t0][x + 57][y + 56][z + 56])) + r1*(r4 + (-8.9285714284415e-4F)*(u[t0][x + 56][y + 52][z + 56] + u[t0][x + 56][y + 60][z + 56]) + 1.26984126982279e-2F*(u[t0][x + 56][y + 53][z + 56] + u[t0][x + 56][y + 59][z + 56]) + (-1.00000000005821e-1F)*(u[t0][x + 56][y + 54][z + 56] + u[t0][x + 56][y + 58][z + 56]) + 8.00000000046566e-1F*(u[t0][x + 56][y + 55][z + 56] + u[t0][x + 56][y + 57][z + 56])) + r2*(r4 + (-8.9285714284415e-4F)*(u[t0][x + 56][y + 56][z + 52] + u[t0][x + 56][y + 56][z + 60]) + 1.26984126982279e-2F*(u[t0][x + 56][y + 56][z + 53] + u[t0][x + 56][y + 56][z + 59]) + (-1.00000000005821e-1F)*(u[t0][x + 56][y + 56][z + 54] + u[t0][x + 56][y + 56][z + 58]) + 8.00000000046566e-1F*(u[t0][x + 56][y + 56][z + 55] + u[t0][x + 56][y + 56][z + 57])) + r3*u[t0][x + 56][y + 56][z + 56] + 1.0e-1F);
                }
              }
            }
          }
