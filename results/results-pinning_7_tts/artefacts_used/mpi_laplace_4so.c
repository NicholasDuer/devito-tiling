          ...
          for (int y0_blk0 = y_m - lower_y_offset; y0_blk0 <= y_M + upper_y_offset; y0_blk0 += y0_blk0_size)
          {
            for (int x = x0_blk0; x <= MIN(x0_blk0 + x0_blk0_size - 1, x_M + upper_x_offset); x += 1)
            {
              for (int y = y0_blk0; y <= MIN(y0_blk0 + y0_blk0_size - 1, y_M + upper_y_offset); y += 1)
              {
                ...
                {
                  float r4 = -1.25F*u[t0][x + 28][y + 28][z + 28];
                u[t1][x + 28][y + 28][z + 28] = dt*(r0*(r4 + (-4.16666666642413e-2F)*(u[t0][x + 26][y + 28][z + 28] + u[t0][x + 30][y + 28][z + 28]) + 6.66666666627862e-1F*(u[t0][x + 27][y + 28][z + 28] + u[t0][x + 29][y + 28][z + 28])) + r1*(r4 + (-4.16666666642413e-2F)*(u[t0][x + 28][y + 26][z + 28] + u[t0][x + 28][y + 30][z + 28]) + 6.66666666627862e-1F*(u[t0][x + 28][y + 27][z + 28] + u[t0][x + 28][y + 29][z + 28])) + r2*(r4 + (-4.16666666642413e-2F)*(u[t0][x + 28][y + 28][z + 26] + u[t0][x + 28][y + 28][z + 30]) + 6.66666666627862e-1F*(u[t0][x + 28][y + 28][z + 27] + u[t0][x + 28][y + 28][z + 29])) + r3*u[t0][x + 28][y + 28][z + 28] + 1.0e-1F);
                }
              }
            }
          }
