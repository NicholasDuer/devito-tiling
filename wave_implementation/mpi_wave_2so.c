                  ...
                  for (int x = x0_blk0; x <= MIN(MIN(x_M + upper_x_offset, wf_x_base + wf_x_width - wf_offset - 1), x0_blk0 + x0_blk0_size - 1); x += 1)
                  {
                    for (int y = y0_blk0; y <= MIN(MIN(y_M + upper_y_offset, wf_y_base + wf_y_width - wf_offset - 1), y0_blk0 + y0_blk0_size - 1); y += 1)
                    {
                      ...
                      for (int z = z_m; z <= z_M; z += 1)
                      {
                        ...
                        u[t2][x + kernel_offset][y + kernel_offset][z + kernel_offset] = (r1*damp[x + kernel_offset][y + kernel_offset][z + kernel_offset]*u[t0][x + kernel_offset][y + kernel_offset][z + kernel_offset] + r2*(-r0*(-2.0F*u[t0][x + kernel_offset][y + kernel_offset][z + kernel_offset]) - r0*u[t1][x + kernel_offset][y + kernel_offset][z + kernel_offset]) + 1.0e-2F*(u[t0][x + kernel_offset - 1][y + kernel_offset][z + kernel_offset] + u[t0][x + kernel_offset][y + kernel_offset - 1][z + kernel_offset] + u[t0][x + kernel_offset][y + kernel_offset][z + kernel_offset - 1] + u[t0][x + kernel_offset][y + kernel_offset][z + kernel_offset + 1] + u[t0][x + kernel_offset][y + kernel_offset + 1][z + kernel_offset] + u[t0][x + kernel_offset + 1][y + kernel_offset][z + kernel_offset]) - 5.99999987e-2F*u[t0][x + kernel_offset][y + kernel_offset][z + kernel_offset])/(r0*r2 + r1*damp[x + kernel_offset][y + kernel_offset][z + kernel_offset]);
                      }
                    } 
                  }
                }
