              ...
              for (int y0_blk0 = MAX(wf_y_base - wf_offset, y_m); y0_blk0 <= wf_y_base + wf_y_width - wf_offset - 1; y0_blk0 += y0_blk0_size) 
              {
                for (int x = x0_blk0; x <= MIN(MIN(x_M, wf_x_base + wf_x_width - wf_offset - 1), x0_blk0 + x0_blk0_size - 1); x += 1)
                {
                  for (int y = y0_blk0; y <= MIN(MIN(y_M, wf_y_base + wf_y_width - wf_offset - 1), y0_blk0 + y0_blk0_size - 1); y += 1)
                  {
                    ...
                    {
                      float r2 = 1.0F/(vp[x + 4][y + 4][z + 4]*vp[x + 4][y + 4][z + 4]);
                      u[t2][x + 4][y + 4][z + 4] = (r1*damp[x + 4][y + 4][z + 4]*u[t0][x + 4][y + 4][z + 4] + r2*(-r0*(-2.0F*u[t0][x + 4][y + 4][z + 4]) - r0*u[t1][x + 4][y + 4][z + 4]) + 8.33333315e-4F*(-u[t0][x + 2][y + 4][z + 4] - u[t0][x + 4][y + 2][z + 4] - u[t0][x + 4][y + 4][z + 2] - u[t0][x + 4][y + 4][z + 6] - u[t0][x + 4][y + 6][z + 4] - u[t0][x + 6][y + 4][z + 4]) + 1.3333333e-2F*(u[t0][x + 3][y + 4][z + 4] + u[t0][x + 4][y + 3][z + 4] + u[t0][x + 4][y + 4][z + 3] + u[t0][x + 4][y + 4][z + 5] + u[t0][x + 4][y + 5][z + 4] + u[t0][x + 5][y + 4][z + 4]) - 7.49999983e-2F*u[t0][x + 4][y + 4][z + 4])/(r0*r2 + r1*damp[x + 4][y + 4][z + 4]);
		                }
                  } 
                }
              }
