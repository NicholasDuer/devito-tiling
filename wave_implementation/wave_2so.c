              ...
              for (int y0_blk0 = MAX(wf_y_base - wf_offset, y_m); y0_blk0 <= wf_y_base + wf_y_width - wf_offset - 1; y0_blk0 += y0_blk0_size) 
              {
                for (int x = x0_blk0; x <= MIN(MIN(x_M, wf_x_base + wf_x_width - wf_offset - 1), x0_blk0 + x0_blk0_size - 1); x += 1)
                {
                  for (int y = y0_blk0; y <= MIN(MIN(y_M, wf_y_base + wf_y_width - wf_offset - 1), y0_blk0 + y0_blk0_size - 1); y += 1)
                  {
                    ...
                    {
                      float r2 = 1.0F/(vp[x + 2][y + 2][z + 2]*vp[x + 2][y + 2][z + 2]);
                      u[t2][x + 2][y + 2][z + 2] = (r1*damp[x + 2][y + 2][z + 2]*u[t0][x + 2][y + 2][z + 2] + r2*(-r0*(-2.0F*u[t0][x + 2][y + 2][z + 2]) - r0*u[t1][x + 2][y + 2][z + 2]) + 1.0e-2F*(u[t0][x + 1][y + 2][z + 2] + u[t0][x + 2][y + 1][z + 2] + u[t0][x + 2][y + 2][z + 1] + u[t0][x + 2][y + 2][z + 3] + u[t0][x + 2][y + 3][z + 2] + u[t0][x + 3][y + 2][z + 2]) - 5.99999987e-2F*u[t0][x + 2][y + 2][z + 2])/(r0*r2 + r1*damp[x + 2][y + 2][z + 2]);
		                }
                  } 
                }
              }
