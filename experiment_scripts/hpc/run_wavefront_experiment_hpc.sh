...
csv_name_wavefront="${experiment_path}/laplace_wavefront_openmp.csv"
csv_name_standard="${experiment_path}/laplace_standard_openmp.csv"

experiment_script="${experiment_path}/experiment_scripts/wavefront_experiment_laplace.py"
